...
through network capable power switches or \acp{BMCs} on the motherboards
of the hosts involved, which can cut the power to the split off hosts.
The termination of the complete cluster through STONITH or Fencing can be prevented
through the determination of the size of the group of reachable cluster members.
