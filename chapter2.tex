...
NFS from version 1 to 3 has no intrinsic lock manager in the protocol. However, there is the \ac{NLM}
protocol, which can work together with the NFS protocol to provide a lock manager.
It is a seperate service of nfs.
Version 4 and later of NFS provide a native lock manager, which enables concurrent access to the files.
% Details
\linebreak[3]
